    ...
    : m_pRedisMemRequest(NULL), m_pRedisOperate(NULL), m_uiSectionFactor(uiSectionFactor)
{
    ...
    m_pRedisOperate = new Storage::RedisOperate();
    ...
    {
        m_pRedisOperate->set_op_type(Storage::RedisOperate::T_WRITE);
    }
    else
    {
        m_pRedisOperate->set_op_type(Storage::RedisOperate::T_READ);
    }
}
...
Storage* RedisOperator::MakeMemOperate()
{
    if (m_pRedisMemRequest == NULL)
    {
        m_pRedisMemRequest = new Storage();
    }
    else
    {
