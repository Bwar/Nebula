 ...
 * Modify history:
 ******************************************************************************/
#ifndef SRC_OBJECT_STEP_PBSTEP_HPP_
#define SRC_OBJECT_STEP_PBSTEP_HPP_
...
{
public:
    PbStep(Step* pNextStep = NULL);
    PbStep(const tagChannelContext& stCtx, const MsgHead& oReqMsgHead, const MsgBody& oReqMsgBody, Step* pNextStep = NULL);
    virtual ~PbStep();
...
#endif /* SRC_OBJECT_STEP_PBSTEP_HPP_ */
