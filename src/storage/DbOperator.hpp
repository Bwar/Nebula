...
public:
    ...
    virtual Storage* MakeMemOperate();
     ...
     * @return 是否添加成功
     */
    virtual bool AddCondition(Storage::DbOperate::Condition::E_RELATION eRelation,
     ...
     */
    virtual void SetConditionGroupRelation(Storage::DbOperate::ConditionGroup::E_RELATION eRelation);
...
protected:
    Storage::DbOperate* GetDbOperate()
    {
        return(m_pDbOperate);
    }
...
private:
    Storage* m_pDbMemRequest;
    Storage::DbOperate* m_pDbOperate;
